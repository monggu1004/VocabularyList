...
// let todaywordAN = document.querySelector(".todaywordAN");
...
// todaylength = todaywords.length;
// randomindex = Math.floor(Math.random() * todaylength);
// todaywordJA.innerText = todaywords[randomindex].japanword;
// todaywordKO.innerText = todaywords[randomindex].koreaword;

// todaywordAN.addEventListener("click", showword);
